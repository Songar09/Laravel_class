	...
	<div class="modal-dialog">
		...
		<div class="modal-body">
					<form @submit.prevent="storeBook" enctype="multipart/form-data">
							...
							<div class="mb-3">
									<label for="srock" class="form-label">Stock</label>
									<input type="number" class="form-control" id="srock" v-model="book.srock">
							</div>
							<div class="mb-3">
									<label for="description" class="form-label">Descripcion</label>
									<textarea class="form-control " id="description" rows="3" v-model="book.
							...
							<button type="button" class="btn btn-secondary me-1" data-bs-dismiss="modal">Close</button>
								<button type="submit" class="btn btn-primary me-1">
									{{`${is_create?'Crear' :'Actualizar'}`}}</button>
...
export default {
	...
	methods: {
		...
		loadFormData(){
			...
			form_data.append('srock', this.book.srock)
